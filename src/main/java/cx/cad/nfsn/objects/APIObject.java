...
public class APIObject {
    ...
    /**
     * Use NotYetImplementedHereException when the NFSN API Reference guide indicates
     * that an API property or method <b>has been implemented</b>, but that support
     * for it has not yet been added to this library.
     */
    public static class NotYetImplementedHereException extends NFSNNotYetImplementedException {
    }

    /**
     * Use NFSNNotYetImplementedException when the NFSN API Reference guide indicates
     * that an API property or method is not implemented.
     */
    public static class NFSNNotYetImplementedException extends NoSuchMethodException {
